...
const Curriculam = () => {
    return (
        <div className=" w-full bg-cover bg-center bg-no-repeat my-20"
        style={{ backgroundImage: "url('../../assets/bg.png')" }}>
            ...
            <div className='wrapper px-4 sm:px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-center gap-12'>
                ...
                <div className="[box-shadow:inset_0_0_28.3px_0.94px_rgba(0,0,0,0.05)] bg-gradient-to-t from-[#FFFFFF] to-[#FFF4DC] py-12 text-center space-y-8 rounded-2xl [border:1px_solid_rgb(222,245,255)]">
                    <Image src={kinder} alt='banna and bread picture ' className='inline-block' />
                ...
                <div className="[box-shadow:inset_0_0_28.3px_0.94px_rgba(0,0,0,0.05)] bg-gradient-to-t from-[#FFFFFF] to-[#F2E8FF] py-12 text-center space-y-8 rounded-2xl [border:1px_solid_rgb(222,245,255)]">
                    <Image src={kinder} alt='banna and bread picture ' className='inline-block' />
